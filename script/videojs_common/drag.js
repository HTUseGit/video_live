        ...
        function $thisRandom(){ //随机函数
            $this.each(function(index){
                ...
                if(movePosition.toLowerCase() == 'x'){
                    ...
                    $(replaceImgPath).attr('src', 'images/live/voice_2.png');
        ...
        $(document).mousemove(function(e){
            ...
            function thisXMove(){ //x轴移动
                if(mDown == true){
                    ...
                    if( volume<0.33 ){
                        $(replaceImgPath).attr('src', 'images/live/voice_1.png');
                    }else if(volume>0.66){
                        $(replaceImgPath).attr('src', 'images/live/voice_3.png');
                    }else{
                        $(replaceImgPath).attr('src', 'images/live/voice_2.png');
                    }
                ...
                if(moveX < 0){
                    ...
                    $(replaceImgPath).attr('src', 'images/live/mute.png');
                }
                if(moveX > (faWidth- 8)){
                    $this.css({"left": '72px'});
